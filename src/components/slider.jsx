        ...
        >
          <div className="sm:px-[100px] px-[50px] pt-[100px]">
            <h1 className="text-[25px] sm:text-[30px] font-bold">
              OUR <span className="text-[#2B77C5]">CUSTOMERS</span>
            </h1>
          </div>
          ...
          <div className="px-[80px] pb-[50px] overflow-x-hidden overflow-y-hidden object-contain">
            <Slider ref={(c) => (this.slider = c)} {...settings}>
              <div className="mr-[40px] h-[250px] !flex items-center">
                <img
                  src={changanLogo}
                  style={{ minWidth: "120px", minHeight: "180px" }}
                  alt=""
                />
              </div>
        ...
        >
          <div className="sm:px-[100px] px-[50px]  pt-[50px]">
            <div className="bg-[#E0B953] w-[70px] h-[70px] sm:w-[80px] sm:h-[80px]  flex justify-center items-center">
              <FontAwesomeIcon
                icon={faQuoteLeft}
                className="text-[30px] sm:text-[40px] text-white"
              />
            </div>
            <div className="ml-[60px] sm:ml-[70px] mt-[-30px]">
              <span className="font-bold text-[16px] sm:text-[20px]">
                WHAT OUR CLIENTS
              </span>
              <br />
              <span className="text-[#4B53F8] text-[16px] sm:text-[20px] font-bold">
                {" "}
                ARE SAYING{" "}
              </span>
            </div>
              ...
              <div className="mr-[40px] h-[200px]  !w-[full] sm:!w-[280px] text-white bg-[#4B53F8] p-[20px] ">
                <div className="border-l ml-[20px] pl-[10px]">
                  <p className="text-[12px] font-extralight">
                    ...
                    since simply dummy text of the printing and typesetting
                    industry.{" "}
                  </p>
                </div>
      ...
      <>
        ...
        <div>
          <div className=" !flex justify-center items-center ">
            <Slider
              className="w-[330px] md:w-[700px] lg:w-[500px]"
              ref={(c) => (this.slider = c)}
              {...settings}
            >
              <div className="!flex items-center justify-center">
                <img
                  src={slider3}
                  className="mr-[10px] h-[220px] sm:h-[220px] md:h-[200px]"
                  alt=""
                />
              </div>
              <div className="!flex items-center justify-center">
